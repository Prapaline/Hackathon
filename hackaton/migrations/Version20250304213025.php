 ...
 */
final class Version20250304213025 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chantier_user_chantier (chantier_id INT NOT NULL, user_chantier_id INT NOT NULL, INDEX IDX_E091DA2479DBCD08 (user_chantier_id), INDEX IDX_E091DA24D0C0049D (chantier_id), PRIMARY KEY(chantier_id, user_chantier_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE user_chantier (id INT AUTO_INCREMENT NOT NULL, start_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', end_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
